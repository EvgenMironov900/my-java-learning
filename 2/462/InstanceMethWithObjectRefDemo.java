...
Нaзoвитe этoт фaйл 462 InstanceMethWithObjectRefDemo.java
*/
...
class InstanceMethWithObjectRefDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Koличecтвo суток, когда самая высокая температура была 89 градусов: " +
                        count);
    ...
    System.out.println("Koличecтвo суток, когда самая высокая температура была 12 градусов: " +
                        count);
    // Использовать lessThanTemp() для нахождения суток, когда температура
    // была ниже указанного значения.
    count = counter(weekDayHighs, HighTemp::lessThanTemp, new HighTemp(89));
    System.out.println("Koличecтвo суток, когда самая высокая " +
                        "температура была меньше 89 градусов: " + count);
    count = counter(weekDayHighs2, HighTemp::lessThanTemp, new HighTemp(19));
    System.out.println("Koличecтвo суток, когда самая высокая температура " +
...
Koличecтвo суток, когда самая высокая температура была 89 градусов: 3
Koличecтвo суток, когда самая высокая температура была 12 градусов: 2
Koличecтвo суток, когда самая высокая температура была меньше 89 градусов: 3
Koличecтвo суток, когда самая высокая температура была меньше 19 градусов: 5
*/
